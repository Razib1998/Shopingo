    ...
    try {
      ...
      if (["approved", "rejected", "pending"].includes(data?.status)) {
        ...
        switch (data?.status) {
          case "approved":
            setMessage(
              "Your store request has been approved,you can now add products to your store from dashboard"
            );
            setTimeout(() => router.push("/store"), 5000);
            break;
          case "rejected":
            setMessage(
              "Your store request has been rejected,contact admin to know details"
            );
            break;
          case "pending":
            setMessage(
              "Your store request has been pending,please wait for admin to approve your store"
            );
